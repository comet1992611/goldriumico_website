 <head>
        <meta charset="utf-8" />
        <title>{{ $gset->webTitle }} - Admin</title>
        ...
        <link href="{{ asset('assets/admin/layouts/layout/css/custom.min.css') }}" rel="stylesheet" type="text/css" />
         ...
         <link href="{{ asset('assets/admin/global/plugins/icheck/skins/all.css') }}" rel="stylesheet" type="text/css" />
        ...
        <!-- color -->
         <link href="{{ asset('assets/admin/global/plugins/bootstrap-colorpicker/css/colorpicker.css') }}" rel="stylesheet" type="text/css" />
