...
<div class="panel panel-primary">
  <div class="panel-body">
          <h3 class="text-bold text-center">{{$user->firstname}} {{$user->lastname}}</h3>
        @if($avatar == null)
          <img  class="img-responsive img-rounded" src="{{ asset('assets/images/avatar/avatar.png') }}" alt="photo" width="15%" style="margin: auto;">
        @else
            <img  class="img-responsive img-rounded" src="{{ asset('assets/images/avatar') }}/{{Auth::id()}}.png" alt="photo" width="15%" style="margin: auto;">
        @endif
        <hr/>
    <div class="form-group text-center">
         <button class="btn btn-success" data-toggle="modal" data-target="#avatarup"><i class="fa fa-upload"></i> Update Profile Photo</button>
    </div>
      <form action="{{route('user.update')}}" method="POST">
                ...
                <option value="Zimbabwe">Zimbabwe</option>
                            ...
                            <div class="form-group col-md-12">
                                <div class="profile-submit-btn text-center">
...
<div id="avatarup" class="modal fade" role="dialog">
          <div class="modal-dialog">
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form role="form" method="POST" action="{{route('cngavatar')}}" enctype="multipart/form-data">
                 {{ csrf_field() }}
                    <div class="form-group">
                         <input type="file" name="photo" class="form-control input-lg"> 

                       <span style="color: #ff6600;">Standard Image Size: 200 x 200 px</span>
                    </div>
                    <div class="form-group">
