    ...
    <!--[if lt IE 9]>
        <script src="{{ asset('assets/user/crossbrowserjs/html5shiv.js') }}"></script>
        <script src="{{ asset('assets/user/crossbrowserjs/respond.min.js') }}"></script>
        <script src="{{ asset('assets/user/crossbrowserjs/excanvas.min.js') }}"></script>
    <![endif]-->
    ...
    <script src="{{ asset('assets/user/plugins/jquery-jvectormap/jquery-jvectormap.min.js') }}"></script>
    <script src="{{ asset('assets/user/plugins/jquery-jvectormap/jquery-jvectormap-world-mill-en.js') }}"></script>
